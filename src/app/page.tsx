...
export default function Landing() {
  ...
  return (
    <div style={{ background: '#131317', color: '#fff', overflowX: 'hidden', fontFamily: 'var(--fm)', position: 'relative' }}>
      ...
      <section style={{ position: 'relative', height: '100svh', display: 'flex', alignItems: 'flex-start', justifyContent: 'center', overflow: 'hidden' }}>
        ...
        <div style={{ position: 'relative', zIndex: 2, width: '100%', padding: '0 clamp(20px,5vw,60px)', paddingTop: 'clamp(90px,16vh,160px)', display: 'flex', flexDirection: 'column', alignItems: 'flex-end' }} className="hero-content">
      ...
      {/* ══ STATS ═════════════════════════════════════════════════ */}
      <section style={{ background: '#131317', position: 'relative', zIndex: 10 }}>
          ...
          <div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px' }} className="weight-cats-grid">
              {[
                ...
                <div key={g.label} style={{ border: '1px solid rgba(255,255,255,0.16)', borderRadius: '4px', overflow: 'hidden', background: '#141414', boxShadow: 'inset 0 1px 0 rgba(255,255,255,0.04)' }}>
                  <div style={{ padding: '16px 24px', background: '#1f1f1f', borderBottom: '1px solid rgba(255,255,255,0.13)', display: 'flex', alignItems: 'center', gap: '10px' }}>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)' }}>
                    {g.cats.map((kg, i) => (
                      <div key={kg} style={{ padding: '18px 16px', borderRight: i % 4 !== 3 ? '1px solid rgba(255,255,255,0.09)' : 'none', borderBottom: i < 4 ? '1px solid rgba(255,255,255,0.09)' : 'none', display: 'flex', alignItems: 'center', justifyContent: 'center', transition: 'background 0.2s' }}
      ...
      <section className="cta-legacy" style={{ minHeight: 'clamp(70vh,86vh,900px)', display: 'flex', alignItems: 'center', justifyContent: 'center', textAlign: 'center', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ position: 'relative', zIndex: 2, padding: '0 20px', maxWidth: '1400px' }}>
          ...
          <Link href="/survey" style={{ textDecoration: 'none' }}>
            <button className="btn-cta-final" style={{ padding: 'clamp(16px,2.5vw,24px) clamp(34px,6vw,74px)', background: 'transparent', color: '#fff', border: '1px solid rgba(255,255,255,0.6)', fontSize: 'clamp(0.72rem,2.2vw,0.95rem)', fontWeight: 900, letterSpacing: '0.28em', cursor: 'pointer', transition: 'all 0.3s', fontFamily: 'var(--fm)', position: 'relative', overflow: 'hidden' }}
      ...
      <style>{`
        ...
        .cta-grid-lines {
          ...
          -webkit-mask-image: radial-gradient(ellipse 65% 60% at 50% 45%, #000 0%, transparent 78%);
          mask-image: radial-gradient(ellipse 65% 60% at 50% 45%, #000 0%, transparent 78%);
        }
        ...
        @media (max-width: 768px) {
          ...
          .hero-content > div { align-items: flex-start !important; }
