  ...
  return (
    <div ref={ref} className={`founder-row${imgLeft ? '' : ' founder-row-reverse'}`}
      ...
      <div className="founder-img-wrap">
        ...
        <div style={{ position: 'absolute', inset: 0, background: imgLeft ? 'linear-gradient(to bottom right, transparent 65%, #0f1118 100%)' : 'linear-gradient(to bottom left, transparent 65%, #0f1118 100%)' }} />
...
export default function Landing() {
  ...
  return (
    <div style={{ background: '#0b0d13', color: '#fff', overflowX: 'hidden', fontFamily: 'var(--fm)', position: 'relative' }}>
      ...
      <section style={{ position: 'relative', height: '100svh', display: 'flex', alignItems: 'flex-start', justifyContent: 'center', overflow: 'hidden' }}>
        ...
        <div style={{ position: 'absolute', inset: 0, background: 'linear-gradient(to bottom, transparent 60%, #0b0d13 100%)', zIndex: 1 }} />
      ...
      {/* ══ STATS ═════════════════════════════════════════════════ */}
      <section style={{ background: '#0b0d13', position: 'relative', zIndex: 10 }}>
      ...
      {/* ══ KATEGORIJE ═══════════════════════════════════════════ */}
      <section id="kategorije" style={{ background: '#0b0d13', borderTop: '1px solid rgba(255,255,255,0.06)', padding: 'clamp(80px,12vw,140px) clamp(20px,5vw,60px)' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          <div style={{ marginBottom: 'clamp(48px,7vw,80px)' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(160px, 1fr))', gap: '10px' }} className="age-cats-grid">
              {AGE_CATS.map((cat, i) => (
                <div key={i} style={{ position: 'relative', border: '1px solid rgba(255,255,255,0.16)', borderRadius: '4px', padding: '22px 20px', background: '#16181e', boxShadow: 'inset 0 1px 0 rgba(255,255,255,0.05)', overflow: 'hidden', transition: 'border-color 0.25s, background 0.25s' }}
                  onMouseEnter={e => { (e.currentTarget as HTMLDivElement).style.borderColor = 'rgba(255,255,255,0.28)'; (e.currentTarget as HTMLDivElement).style.background = '#1e2128' }}
                  onMouseLeave={e => { (e.currentTarget as HTMLDivElement).style.borderColor = 'rgba(255,255,255,0.16)'; (e.currentTarget as HTMLDivElement).style.background = '#16181e' }}>
          ...
          <div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px' }} className="weight-cats-grid">
              {[
                ...
                <div key={g.label} style={{ border: '1px solid rgba(255,255,255,0.16)', borderRadius: '4px', overflow: 'hidden', background: '#13151b', boxShadow: 'inset 0 1px 0 rgba(255,255,255,0.04)' }}>
                  <div style={{ padding: '16px 24px', background: '#1e2128', borderBottom: '1px solid rgba(255,255,255,0.13)', display: 'flex', alignItems: 'center', gap: '10px' }}>
      ...
      {/* ══ FOUNDERS ══════════════════════════════════════════════ */}
      <section id="coach" style={{ background: '#0f1118', borderTop: '1px solid rgba(255,255,255,0.06)', overflow: 'hidden' }}>
      ...
      {/* ══ SYSTEM ════════════════════════════════════════════════ */}
      <section id="system" style={{ background: '#0b0d13', padding: 'clamp(80px,12vw,150px) clamp(20px,5vw,60px)', borderTop: '1px solid rgba(255,255,255,0.06)' }}>
