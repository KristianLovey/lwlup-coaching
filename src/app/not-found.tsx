...
export default function NotFound() {
  ...
  return (
    <div style={{
      ...
      {/* Glow */}
      <div style={{ position: 'fixed', top: '50%', left: '50%', transform: 'translate(-50%,-50%)', width: '600px', height: '600px', borderRadius: '50%',
        background: 'radial-gradient(circle,rgba(255,255,255,0.03) 0%,transparent 70%)', pointerEvents: 'none', zIndex: 0 }} />
      ...
      <div style={{ position: 'relative', zIndex: 1, textAlign: 'center', padding: '40px 24px',
        ...
        <div style={{ display: 'flex', gap: '10px', justifyContent: 'center', flexWrap: 'wrap' }}>
          <Link href="/" style={{
            ...
            textDecoration: 'none', fontSize: '0.68rem', letterSpacing: '0.25em',
            fontFamily: 'var(--fm)', fontWeight: 700, transition: 'all 0.2s',
          }}
