...
export default function TeamPage() {
  ...
  return (
    <div style={{ background: '#0b0d13', color: '#fff', minHeight: '100vh', fontFamily: 'var(--fm)', overflowX: 'hidden' }}>
      ...
      {/* STATS */}
      <section style={{ background: '#0b0d13', padding: '80px 60px', borderTop: '1px solid rgba(255,255,255,0.08)', borderBottom: '1px solid rgba(255,255,255,0.08)', position: 'relative', zIndex: 1 }}>
        <div ref={statsReveal.ref} className="team-stats-grid" style={{ maxWidth: '1400px', margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '1px', background: 'rgba(255,255,255,0.08)' }}>
          {TEAM_STATS.map((stat, i) => (
            <div key={i} className="team-stat-card" style={{ textAlign: 'center', padding: '48px 20px', background: '#0b0d13', transition: 'all 0.4s', opacity: statsReveal.visible ? 1 : 0, transform: statsReveal.visible ? 'none' : 'translateY(25px)', transitionDelay: `${i * 0.08}s`, transitionDuration: '0.7s' }}>
      ...
      {/* CTA */}
      <section style={{ padding: '120px 60px', background: '#0b0d13', borderTop: '1px solid rgba(255,255,255,0.08)', textAlign: 'center', position: 'relative', zIndex: 1 }}>
